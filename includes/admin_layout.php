...
function admin_nav(): array
{
    ...
    return [
        ...
        ['tuts',     'آموزش‌ها',           $icons['tut'],      '/admin/tutorials.php', true],
        ['tutcats',  'دسته‌های آموزش',     $icons['cats'],     '/admin/tutorial-categories.php', true],
        ['faq',      'سؤالات متداول',      $icons['faq'],      '/admin/faq.php',       true],
        ['testi',    'نظر مشتریان',        $icons['testi'],    '/admin/testimonials.php', true],
