...
('pricing-mistakes', '۷ اشتباه رایج در قیمت‌گذاری دوخت سفارشی', 'قیمت پایین همیشه مشتری نمی‌آورد؛ گاهی فقط سود تو را آب می‌کند. این ۷ اشتباه را بشناس و از فردا درست قیمت بده.', '<p>قیمت پایین همیشه مشتری نمی‌آورد؛ گاهی فقط سود تو را آب می‌کند. این ۷ اشتباه را بشناس و از فردا درست قیمت بده.</p><p>[محتوای کامل مقاله — placeholder]</p>', 3, 'published', '2026-06-23 10:00:00', 5),
...
-- Seed rows mirror the export's static tutorial list. content_json stays
-- empty ('[]') in Phase 1; Phase 4 migrates the sample fragments into the
-- structured JSON format and the public SPA switches from static data to
-- the API. video_type='aparat' marks tutorials whose design shows a video
-- block (embed code itself is a Phase 4 placeholder).
INSERT INTO tutorials (slug, title, category_id, duration_minutes, status, sort_order, video_type, content_json, troubleshooting_json) VALUES
('install-android', 'چطور دوختک را روی گوشی اندروید نصب کنم؟', 1, 3, 'published', 1, 'aparat', '[]', '[]'),
('install-iphone', 'چطور دوختک را روی آیفون نصب کنم؟', 1, 3, 'published', 2, 'aparat', '[]', '[]'),
('signup-login', 'چطور ثبت‌نام و وارد شوم؟', 1, 4, 'published', 3, 'aparat', '[]', '[]'),
('app-tour', 'آشنایی با صفحه اصلی اپ', 1, 5, 'published', 4, 'none', '[]', '[]'),
('add-customer', 'چطور مشتری جدید ثبت کنم؟', 2, 3, 'published', 5, 'aparat', '[]', '[]'),
('add-measurements', 'چطور اندازه‌های اندام مشتری را ثبت کنم؟', 2, 4, 'published', 6, 'aparat', '[]', '[]'),
('find-edit-customer', 'چطور مشتری را پیدا و ویرایش کنم؟', 2, 2, 'published', 7, 'none', '[]', '[]'),
('first-order', 'چطور اولین سفارشم را ثبت کنم؟', 3, 4, 'published', 8, 'aparat', '[]', '[]'),
('order-status', 'مراحل و وضعیت سفارش چطور کار می‌کند؟', 3, 3, 'published', 9, 'none', '[]', '[]'),
('order-deadline', 'چطور سررسید تحویل تنظیم کنم؟', 3, 2, 'published', 10, 'none', '[]', '[]'),
('refer-order', 'چطور سفارش را به همکار ارجاع بدهم؟', 3, 4, 'published', 11, 'aparat', '[]', '[]'),
('gallery-upload', 'چطور عکس و فیلم نمونه‌کار آپلود کنم؟', 4, 4, 'published', 12, 'aparat', '[]', '[]'),
('gallery-categories', 'چطور گالری را دسته‌بندی کنم؟', 4, 2, 'published', 13, 'none', '[]', '[]'),
('gallery-share', 'چطور لینک گالری را برای مشتری بفرستم؟', 4, 3, 'published', 14, 'aparat', '[]', '[]'),
('sms-activate', 'چطور سامانه پیامکی را فعال کنم؟', 5, 4, 'published', 15, 'aparat', '[]', '[]'),
('sms-bulk', 'چطور پیامک انبوه بفرستم؟', 5, 3, 'published', 16, 'none', '[]', '[]'),
('sms-birthday', 'چطور تبریک تولد خودکار را روشن کنم؟', 5, 2, 'published', 17, 'none', '[]', '[]'),
('sms-dedicated-line', 'چطور خط اختصاصی بگیرم؟', 5, 3, 'published', 18, 'none', '[]', '[]'),
('payment-activate', 'چطور درگاه پرداخت را فعال کنم؟', 6, 5, 'published', 19, 'aparat', '[]', '[]'),
('payment-link', 'چطور لینک پرداخت بسازم و بفرستم؟', 6, 3, 'published', 20, 'aparat', '[]', '[]'),
('payment-track', 'چطور پرداخت‌ها را پیگیری کنم؟', 6, 2, 'published', 21, 'none', '[]', '[]'),
('account-income-expense', 'چطور درآمد و هزینه ثبت کنم؟', 7, 4, 'published', 22, 'aparat', '[]', '[]'),
('account-cheques', 'چطور چک ثبت کنم و یادآوری بگیرم؟', 7, 3, 'published', 23, 'none', '[]', '[]'),
('account-reports', 'گزارش‌های مالی را کجا ببینم؟', 7, 3, 'published', 24, 'none', '[]', '[]'),
('custom-domain', 'چطور دامنه اختصاصی وصل کنم؟', 8, 6, 'published', 25, 'aparat', '[]', '[]'),
('staff-access', 'چطور پرسنل و دسترسی‌ها را مدیریت کنم؟', 8, 4, 'published', 26, 'none', '[]', '[]'),
...
('features', 'امکانات دوختک', 'مدیریت سفارش، پرونده مشتری و اندازه‌ها، گالری نمونه‌کار، لینک پرداخت، حسابداری و باشگاه مشتریان — امکانات کامل دوختک.'),
('pricing', 'تعرفه‌های دوختک', 'تعرفه پلن پایه و پلن ویژه دوختک به‌همراه ماژول‌های تکمیلی؛ ۱۰ روز تست رایگان بدون کارت بانکی.'),
('tutorials', 'مرکز آموزش دوختک', 'آموزش قدم‌به‌قدم کار با دوختک: از نصب و ثبت‌نام تا سفارش، گالری، پیامک، پرداخت و حسابداری.'),
('blog', 'مجله دوختک', 'نکته‌ها و ترفندهای مدیریت خیاطی و مزون‌داری در مجله دوختک.'),
('about', 'درباره دوختک', 'قصه دوختک و تیمی که آن را برای خیاط‌ها و مزون‌دارهای ایران می‌سازد.'),
('contact', 'تماس با دوختک', 'برای مشاوره رایگان و شروع کار با دوختک با ما در تماس باشید.');
