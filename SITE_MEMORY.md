...
نقطه‌های بازگشت (تگ‌ها local هستند — پروکسی گیت این محیط push تگ را نمی‌پذیرد؛ هش‌ها مرجع‌اند): فاز ۱ = `4a27345`، فاز ۲ = `2c59af1`، فاز ۳ = `3a58faf`، فاز ۴ = `9ffaa01`، فاز ۵ = `cc90660`.
